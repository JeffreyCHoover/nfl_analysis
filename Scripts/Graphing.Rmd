...
kable(head(rb, 30), booktabs = TRUE, 
...
kable(head(qb, 30), booktabs = TRUE, 
...
kable(head(wr_te, 30), booktabs = TRUE, 
...
kable(head(teamData, 30), booktabs = TRUE, 
        caption = 'A table of the top 30 team performances by season.')
```